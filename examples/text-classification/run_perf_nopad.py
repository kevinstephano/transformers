...
benchmark_cmd = ['python', 'run_glue.py', '--fp16', '--overwrite_output_dir', '--model_name_or_path', 'bert-base-cased', \
...
#subprocess.run(cmd_list, stdout=sys.stdout, stderr=sys.stderr, universal_newlines=True, shell=True, cwd=os.getcwd())
